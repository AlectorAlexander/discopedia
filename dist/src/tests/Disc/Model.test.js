...
describe('DiskModel', () => {
    ...
    let diskModel;
    beforeAll(() => {
        mongoose_1.default.connect('mongodb+srv://Alector:BRma0OxmWerHtPWe@discopedy.o63qtdk.mongodb.net/?retryWrites=true&w=majority', {});
    });
    afterAll(() => {
    ...
    beforeEach(() => {
        ...
        diskModel = new DisksModel_1.default();
    });
